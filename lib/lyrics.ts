/**
 * Official lyrics sourced from jonimitchell.com
 * Album: Hejira (1976) — © Crazy Crow Music (BMI)
 *
 * Structured as: slug → array of stanzas → array of lines per stanza.
 * Annotations are referenced by [stanzaIndex, lineIndex] in song-content.ts,
 * keeping the lyric text untouchable.
 */
...
export const lyrics: Record<string, string[][]> = {
  ...
  "song-for-sharon": [
    ...
    [
      ...
      "A blank face at the window stares and stares and stares and stares and stares",
    ],
    [
